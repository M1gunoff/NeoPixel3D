...
const Home = () => {
  ...
  return (
    <motion.div className="home__container" animate={controls} variants={pricingVariants} ref={ref} initial="hidden">
        <motion.h1 variants={containerVariants(1)}>Neopixel <motion.span variants={containerVariants(1.4)} className="home__titleRed">Ruby</motion.span></motion.h1>
        <motion.span variants={containerVariants(2)}className="home__description">
          ...
          <motion.div variants={containerVariants(3)} className="home__button__wrapper">
            <motion.a href="#contacts" className="home__button--red">Заказать</motion.a>
          </motion.div>
        </motion.span>
    </motion.div>
  );
