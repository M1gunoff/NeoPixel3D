...
import { SphereGallery } from '../../../data/data';
import "slick-carousel/slick/slick.css"; 
import "slick-carousel/slick/slick-theme.css";
import { motion, useAnimation } from 'framer-motion';
import { useInView } from 'react-intersection-observer';
import './BlueSpheres.css';
...
const Gallery = () => {
  ...
  return (
    <motion.div 
      ...
      ref={ref}
    >
      <motion.h1 variants={containerVariants(2)}>Сферы применения</motion.h1>
      <motion.div variants={containerVariants(2.4)} className="separator"></motion.div>
      <Slider {...settings}>
        {SphereGallery.map((image, index) => (
          <motion.div 
            key={image.id} 
